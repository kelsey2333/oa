        ...
        <div class="col-md-12 column">
            <table class="table">
               ...
               <c:forEach items="${records}" var="record">
                   <tr>
                       <td>${record.applyerId}</td>
                       <td>${record.applyerName}</td>
                       <td><fmt:formatDate value="${record.startTime}" pattern="yyyy-MM-dd HH:mm"/></td>
                       <td><fmt:formatDate value="${record.endTime}" pattern="yyyy-MM-dd HH:mm"/></td>
                       <td><button type="button" class="btn btn-default btn-warning" onclick="location.href = '${base}/leave/approval/detail/${record.id}'">查看详细</button></td>
                   </tr>
               </c:forEach>
                </tbody>
            </table>

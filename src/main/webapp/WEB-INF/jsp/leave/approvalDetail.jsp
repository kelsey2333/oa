                ...
                <div class="col-md-3 column">
                    <div class="list-group">
                        <c:forEach items="${subMenus}" var="subMenu">
                            <c:choose>
                                <c:when test="${subMenu.menuName == '请假审批'}">
...
<div class="container">
    <div class="row clearfix">
        <div class="col-md-12 column">
            ...
            <tr class="warning">
                <td>请假开始时间</td>
                <td><fmt:formatDate value="${details.startTime}" pattern="yyyy-MM-dd HH:mm"/> </td>
                <td>请假结束时间</td>
                <td><fmt:formatDate value="${details.endTime}" pattern="yyyy-MM-dd HH:mm"/> </td>
            </tr>
            <tr >
                <td rowspan="2">请假事由</td>
...
<div class="container">
    <div class="row clearfix">
        <div class="col-md-12 column">
            <form action="${base}/leave/approval/handle.do">
                <table class="table">
                    <tbody>
                    <tr class="success">
                        <td>记录编号</td>
                    ...
                    <tr>
                        <td colspan="4"><input type="submit" value="提交审批"></td>
                    </tr>
                    </tbody>
                </table>
            </form>
